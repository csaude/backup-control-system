...
/* Angular Material */
import {DialogOverviewExampleDialog } from './syncs.component';
...
import { MaterialTimeControlModule } from '../shared/material-time-control.module';
...
@NgModule({
  ...
  providers: [
    SyncsService, DatePipe,MatDatepickerModule
  ],
  entryComponents:[
    DialogOverviewExampleDialog
  ]
