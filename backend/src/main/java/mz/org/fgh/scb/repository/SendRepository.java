...
public interface SendRepository extends JpaRepository<Send, Long> {
	...
	public Page<Send> findByDistrictId(@Param("district_id") Long district_id, Pageable pageable,@Param("from") Date from, @Param("until") Date until);
	...
	public Page<Send> findByUserId(Pageable pageable, @Param("username") String username);
	...
	public Page<Send> findByUserId(Pageable pageable, @Param("from") Date from, @Param("until") Date until, @Param("username") String username);
